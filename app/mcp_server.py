...
@mcp.tool(
    description=(
        ...
        "Body fields (decisions, design, key_points, symptom, "
        "topics[].points, ...) take a list of items, rendered in the order "
        "you send them. A plain string is a PARAGRAPH — use it for prose, "
        "and its line breaks are preserved. Use {\"type\": \"bullet\", "
        "...} only for a real list (it can nest via depth and take a "
        "checkbox via checked), {\"type\": \"code\", ...} for "
        "YAML/shell/config/logs, {\"type\": \"table\", ...} for tabular "
        "data, {\"type\": \"quote\", ...} for a quotation or Obsidian "
        "callout. Example: [\"背景を説明する文章\", {\"type\": \"code\", "
        "\"language\": \"yaml\", \"content\": \"a: 1\"}, \"補足の文章\"].\n"
